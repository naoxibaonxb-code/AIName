<template>
  <view class="page"><view class="safe" />
    <view class="topbar"><view class="back" @tap="back">‹</view><view><text class="eyebrow">{{ isAdmin ? 'ADMIN CONSOLE' : 'KNOWLEDGE BASE' }}</text><view class="title">知识库管理</view></view><view class="spacer" /></view>
    <view class="content">
      <view v-if="isAdmin" class="admin-tabs"><view class="admin-tab" @tap="toUsers">用户管理</view><view class="admin-tab" @tap="toUsage">调用统计</view><view class="admin-tab active">知识库</view><view class="admin-tab" @tap="toAnnouncements">公告</view></view>
      <view class="overview">
